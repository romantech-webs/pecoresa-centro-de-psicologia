  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="pecoresa-centro-de-psicologia";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="PECORESA, centro de Psicología y Logopedia."
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="pecoresa-centro-de-psicologia"
          data-primary-color="#88594b"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="pecoresa-centro-de-psicologia";
